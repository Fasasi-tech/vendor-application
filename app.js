...
const customerRfqRoute = require('./Routes/customerRfqRoutes')
const customError = require('./utils/CustomError')
const initSocketServer = require('./socketServer')
const globalErrorHandler = require('./middleware/errorMiddleware')
const mongoose = require('mongoose')
const bodyParser = require('body-parser');
const customerRfqResponseRoute = require('./Routes/customerRfqResponseRoute')
const permissionRoute = require('./Routes/rbacRoutes')
...
app.use('/api/v1/customerRfqs', customerRfqRoute)
app.use('/api/v1/responses', customerRfqResponseRoute)
